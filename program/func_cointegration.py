...
# Calculate Cointegration drom course
...
def calculate_cointegration(series_1, series_2):
    ...
    coint_flag = 0
    coint_res = coint(series_1, series_2)
    if len(coint_res) >= 3:  # Ensure cointegration result has at least 3 elements
        t_value = coint_res[0]
        p_value = coint_res[1]
        crit_value = coint_res[2][1]  # Extract critical value from the cointegration result
